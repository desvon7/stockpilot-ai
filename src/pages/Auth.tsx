            ...
            <div className="glass-card rounded-lg p-8">
              ...
              {activeTab === 'signin' ? (
                <form onSubmit={handleSignIn} className="space-y-6">
                  ...
                  <button 
                    type="submit"
                    className="bg-primary text-primary-foreground hover:bg-primary/90 w-full py-2 rounded-md font-medium flex items-center justify-center gap-2 transition-colors"
                  >
                    Sign In
                    <ArrowRight size={18} />
                  </button>
